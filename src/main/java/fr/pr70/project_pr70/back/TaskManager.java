...
public class TaskManager
{
     ...
     */
    public void createTask(String _name, String _description, Date _deadline, Priority _priority)
    {
        Task newTask = new Task(_name, _description, _deadline, _priority);
        tasks.add(newTask);
    }
     ...
     */
    public void editTask(Task _task, String _name, String _description, Date _deadline, Priority _priority)
    {
